...
import ImageModal from "../../../../components/partials/e-commerce/modals/ImageModal";
...
const ShopList = () => {
  ...
  useEffect(() => {
    ...
    // if (onSearchText !== "") {
    //   const filteredObject = shopData.filter((item) => {
    //     return (
